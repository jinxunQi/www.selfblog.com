<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"H:\www.selfblog.com\public/../application/admin\view\tags\edit.html";i:1563557795;s:61:"H:\www.selfblog.com\application\admin\view\common\header.html";i:1563292524;s:58:"H:\www.selfblog.com\application\admin\view\common\top.html";i:1563464602;s:62:"H:\www.selfblog.com\application\admin\view\common\sidebar.html";i:1563556687;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>个人博客</title>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('admin/index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('admin/tags/index'); ?>">tags标签管理</a>
                    </li>
                                        <li class="active">修改tags标签</li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改tags标签</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <!--编辑页要带隐藏域 否则无法知道是哪条数据做修改-->
                        <input type="hidden" name="id" value="<?php echo $tag['id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">tags标签名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="tagname" placeholder="" value="<?php echo $tag['tagname']; ?>" name="tagname" required="" type="text">
                            </div>
