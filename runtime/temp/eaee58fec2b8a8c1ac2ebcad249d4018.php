<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"H:\www.selfblog.com\public/../application/admin\view\tags\index.html";i:1563557391;s:61:"H:\www.selfblog.com\application\admin\view\common\header.html";i:1563292524;s:58:"H:\www.selfblog.com\application\admin\view\common\top.html";i:1563558239;s:62:"H:\www.selfblog.com\application\admin\view\common\sidebar.html";i:1563556687;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>个人博客</title>
...
<button type="button" tooltip="添加链接" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('admin/tags/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">s
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="8%">tag标签名称</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    <td align="center"><?php echo $tag['id'] ?></td>
                                    <td align="center"><?php echo $tag['tagname']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('admin/tags/edit',['id'=>$tag['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="<?php echo url('admin/tags/del',['id'=>$tag['id']]); ?>" onClick="return confirm('确实要删除吗?');" class="btn btn-danger btn-sm shiny">
