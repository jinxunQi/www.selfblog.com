<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"H:\www.selfblog.com\public/../application/admin\view\cate\index.html";i:1563370996;s:61:"H:\www.selfblog.com\application\admin\view\common\header.html";i:1563292524;s:58:"H:\www.selfblog.com\application\admin\view\common\top.html";i:1563558239;s:62:"H:\www.selfblog.com\application\admin\view\common\sidebar.html";i:1563556687;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>个人博客</title>
...
<button type="button" tooltip="添加链接" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('admin/cate/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">s
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <td align="center"><?php echo $cate['catename']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('admin/cate/edit',['id'=>$cate['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="<?php echo url('admin/cate/del',['id'=>$cate['id']]); ?>" onClick="return confirm('确实要删除吗?');" class="btn btn-danger btn-sm shiny">
