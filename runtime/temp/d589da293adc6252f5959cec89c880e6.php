<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"H:\www.selfblog.com\public/../application/index\view\search\index.html";i:1563555500;s:61:"H:\www.selfblog.com\application\index\view\common\header.html";i:1563558128;s:60:"H:\www.selfblog.com\application\index\view\common\right.html";i:1563552482;s:61:"H:\www.selfblog.com\application\index\view\common\footer.html";i:1563285215;}*/ ?>
...
<div class="position">搜索：<a href="http://www.selfblog.com/index/search/index?keywords=<?php echo $keywords; ?>"><span style="color:#f00; font-weight: bold;"><?php echo $keywords; ?></span></a> </div>

<div class="overall">

	<div class="left">
		<?php if(is_array($searchres) || $searchres instanceof \think\Collection || $searchres instanceof \think\Paginator): if( count($searchres)==0 ) : echo "" ;else: foreach($searchres as $key=>$article): ?>
			<div class="xnews2">
